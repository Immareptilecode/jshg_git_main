...
var send_shareCapital=function(url, mem, url_get){
		...
		$.ajax({
		    url: url,
		    type: "POST",
		    data: {csrfmiddlewaretoken: csrftoken, Amount:$("#sharecapital_amnt").val(), date:$("#sharecapital_date").val(), group:mem},
		    ...
		    error: function(f){
		    		...
		    		setTimeout(hide_error_share_capital, 2000)
...
var Group_sharecapital_ops = Group_sharecapital_ops || (function(){
